...
const WhatsAppFloat = () => {
    useEffect(() => {
        // Adicionar o script para o botão flutuante
        const script = document.createElement('script');
        script.innerHTML = `
      var codeWpRedirectLink = "d99778db0";
    `;
    ...
    return (
        <div className="fixed bottom-6 left-6 z-50">
            <a
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-9 h-9 fill-white">
