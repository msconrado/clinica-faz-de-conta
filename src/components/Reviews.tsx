    ...
    return (
        <section id="reviews" className="py-16 px-4 sm:px-6 lg:px-8 bg-accent-blue/10">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-3xl sm:text-4xl font-bold text-primary-dark mb-8 font-hoss text-center uppercase">NOSSA LOCALIZAÇÃO</h2>
                <div className="flex justify-center">
                    <div className="cursor-pointer relative max-w-4xl w-full" onClick={handleMapClick}>
                        <iframe
                            ...
                            className="shadow-lg"
                        />
                        <div className="absolute inset-0 bg-transparent hover:bg-primary/10 transition-colors duration-300 rounded-lg"></div>
                    </div>
                </div>
            </div>
        </section>
