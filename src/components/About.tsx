    ...
    return (
        <section id="about" className="py-8 px-4 sm:px-6 lg:px-8 bg-accent-blue/20 relative">
            ...
            <div className="max-w-7xl mx-auto relative">
                <h2 className="text-3xl sm:text-4xl font-bold text-primary-dark mb-6 font-hoss text-center uppercase">SOBRE NÓS</h2>
                        ...
                        <CardContent className="p-6">
                            <div className="space-y-4 text-lg text-neutral-dark font-como text-justify">
                                <p className="indent-8">
                                    Bem-vindo à Clínica Faz de Conta, onde a imaginação ganha asas e o desenvolvimento infantil encontra seu espaço
                                ...
                                <p className="indent-8">
                                    ...
                                    explorar, aprender e crescer. Aqui, acreditamos que estimular brincando é uma forma poderosa de aprender sobre o
                                    Mundo e sobre si mesma.
                                </p>
                                <p className="indent-8">
                                    Agora imagine, sonhe e celebre, pois é assim que encontramos a essência do que significa acreditar, e o verdadeiro
                                    poder da criação com fé e cor.
                                </p>
                            </div>
                        </CardContent>
                    </Card>
